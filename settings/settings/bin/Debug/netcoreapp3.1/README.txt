...
(V1.1) We also included a 6k4l and 6k4lfade for ksh charts. These are not generated by 
the program though.
...
(V1.1) There are a few image customizations already available inside the !change resources 
folder. Just copy paste the folder inside one of the customizations into the root of the skin.
